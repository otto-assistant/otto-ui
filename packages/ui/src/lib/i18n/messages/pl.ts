...
export const dict: Record<I18nKey, string> = {
  ...
  'settings.openchamber.desktopAutostart.title': 'Uruchom przy logowaniu',
  'settings.openchamber.desktopAutostart.field.enabledAria': 'Uruchom OpenChamber automatycznie przy logowaniu',
  'settings.openchamber.desktopAutostart.field.enabled': 'Uruchom OpenChamber przy logowaniu',
  'settings.openchamber.desktopAutostart.field.enabledDescription': 'Uruchamia w tle, aby lokalny sidecar pozostał gotowy bez otwartego okna.',
  'settings.openchamber.desktopAutostart.error.loadFailed': 'Nie udało się odczytać preferencji uruchamiania przy logowaniu',
  'settings.openchamber.desktopAutostart.error.saveFailed': 'Nie udało się zaktualizować preferencji uruchamiania przy logowaniu',
