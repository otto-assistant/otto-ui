...
export const dict: Record<I18nKey, string> = {
  ...
  'helpDialog.item.cycleAgent': '循环切换代理（聊天输入）',
  ...
  'agentManager.sidebar.search.placeholder': '搜索 Agent 组...',
  'agentManager.sidebar.actions.newAgentGroup': '新建 Agent 组',
  'agentManager.sidebar.actions.more': '... 更多（{count}）',
  'agentManager.sidebar.actions.showLess': '收起',
  'agentManager.sidebar.section.agentGroups': 'Agent 组',
  'agentManager.sidebar.state.loading': '加载中...',
  'agentManager.sidebar.state.noGroupsFound': '未找到分组',
  'agentManager.sidebar.state.noGroupsYet': '还没有 Agent 组',
  'agentManager.sidebar.state.createToGetStarted': '创建一个新的 Agent 组以开始使用',
  ...
  'agentManager.sidebar.dialog.deleteGroupTitle': '删除 Agent 组',
  ...
  'agentManager.empty.agent.description': '默认使用你配置的默认 agent',
  ...
  'agentManager.empty.actions.startAgentGroupAria': '启动 Agent 组',
  ...
  'agentManager.empty.toast.failedToCreateGroup': '创建 Agent 组失败',
  ...
  'projectActions.actions.addActionAria': '添加动作',
  'projectActions.actions.addAction': '添加动作',
  'projectActions.actions.addNewAction': '添加新动作',
  'projectActions.actions.chooseActionAria': '选择项目动作',
  'projectActions.actions.runNamedAria': '运行 {name}',
  'projectActions.actions.stopNamedAria': '停止 {name}',
  'projectActions.label.fallbackAction': '动作',
  'projectActions.toast.openedUrlFromOutput': '已从动作输出中打开 URL',
  'projectActions.toast.openedForwardedUrl': '已打开转发 URL',
  'projectActions.toast.openedActionUrl': '已打开动作 URL',
  'projectActions.error.noActiveDirectory': '没有活动目录',
  'projectActions.error.noActiveDirectoryForAction': '没有可用于该动作的活动目录',
  ...
  'projectActions.error.failedToRunAction': '运行动作失败',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenChamber 未自动检测到 OpenCode，请在下方设置二进制路径。',
