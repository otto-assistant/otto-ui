...
export const dict: Record<I18nKey, string> = {
  ...
  'memoryView.heading': '记忆',
  'memoryView.tab.graph': '图谱',
  'memoryView.tab.list': '列表',
  'memoryView.tab.diary': '日记',
  'memoryView.tab.search': '搜索',
  'memoryView.tab.file': 'MEMORY.md',
  'memoryView.stats.entities': '{count} 个实体',
  'memoryView.stats.relations': '{count} 条关系',
  'memoryView.file.noProject': '选择一个项目以查看其 MEMORY.md 文件。',
  'memoryView.file.loading': '正在加载 MEMORY.md...',
  'memoryView.file.missingTitle': '还没有 MEMORY.md',
  'memoryView.file.missingDescription': 'Otto 在会话开始时从项目根目录读取 MEMORY.md。智能体会在其中记录值得跨会话保留的经验、决策和上下文。',
  'memoryView.file.creating': '创建中...',
  'memoryView.file.createAction': '创建 MEMORY.md',
  'memoryView.file.unsaved': '未保存的更改',
  'memoryView.file.reloadAria': '重新加载 MEMORY.md',
  'memoryView.file.saving': '保存中...',
  'memoryView.file.saveAction': '保存',
  'memoryView.file.saveFailed': '保存 MEMORY.md 失败',
  'memoryView.file.placeholder': '项目记忆为空。',
  'memoryView.file.editorAria': 'MEMORY.md 编辑器',
};
