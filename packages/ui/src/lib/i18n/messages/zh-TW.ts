...
export const dict: Record<I18nKey, string> = {
  ...
  'connectionStatus.reconnecting': '重新連線中',
  'connectionStatus.disconnected': '已中斷連線',
  'memoryView.heading': '記憶',
  'memoryView.tab.graph': '圖譜',
  'memoryView.tab.list': '清單',
  'memoryView.tab.diary': '日記',
  'memoryView.tab.search': '搜尋',
  'memoryView.tab.file': 'MEMORY.md',
  'memoryView.stats.entities': '{count} 個實體',
  'memoryView.stats.relations': '{count} 條關係',
  'memoryView.file.noProject': '選擇一個專案以檢視其 MEMORY.md 檔案。',
  'memoryView.file.loading': '正在載入 MEMORY.md...',
  'memoryView.file.missingTitle': '尚無 MEMORY.md',
  'memoryView.file.missingDescription': 'Otto 會在工作階段開始時從專案根目錄讀取 MEMORY.md。代理會在其中記錄值得跨工作階段保留的經驗、決策與情境。',
  'memoryView.file.creating': '建立中...',
  'memoryView.file.createAction': '建立 MEMORY.md',
  'memoryView.file.unsaved': '未儲存的變更',
  'memoryView.file.reloadAria': '重新載入 MEMORY.md',
  'memoryView.file.saving': '儲存中...',
  'memoryView.file.saveAction': '儲存',
  'memoryView.file.saveFailed': '儲存 MEMORY.md 失敗',
  'memoryView.file.placeholder': '專案記憶為空。',
  'memoryView.file.editorAria': 'MEMORY.md 編輯器',
};
