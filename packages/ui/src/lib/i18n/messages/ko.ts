...
export const dict: Record<I18nKey, string> = {
  ...
  'memoryView.heading': '메모리',
  'memoryView.tab.graph': '그래프',
  'memoryView.tab.list': '목록',
  'memoryView.tab.diary': '일기',
  'memoryView.tab.search': '검색',
  'memoryView.tab.file': 'MEMORY.md',
  'memoryView.stats.entities': '엔터티 {count}개',
  'memoryView.stats.relations': '관계 {count}개',
  'memoryView.file.noProject': 'MEMORY.md 파일을 보려면 프로젝트를 선택하세요.',
  'memoryView.file.loading': 'MEMORY.md 불러오는 중...',
  'memoryView.file.missingTitle': '아직 MEMORY.md가 없습니다',
  'memoryView.file.missingDescription': 'Otto는 세션 시작 시 프로젝트 루트의 MEMORY.md를 읽습니다. 에이전트는 세션 간에 보존할 학습 내용, 결정, 컨텍스트를 여기에 저장합니다.',
  'memoryView.file.creating': '생성 중...',
  'memoryView.file.createAction': 'MEMORY.md 생성',
  'memoryView.file.unsaved': '저장되지 않은 변경 사항',
  'memoryView.file.reloadAria': 'MEMORY.md 다시 불러오기',
  'memoryView.file.saving': '저장 중...',
  'memoryView.file.saveAction': '저장',
  'memoryView.file.saveFailed': 'MEMORY.md 저장 실패',
  'memoryView.file.placeholder': '프로젝트 메모리가 비어 있습니다.',
  'memoryView.file.editorAria': 'MEMORY.md 편집기',
};
