...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "memoryView.heading": "Memória",
  "memoryView.tab.graph": "Grafo",
  "memoryView.tab.list": "Lista",
  "memoryView.tab.diary": "Diário",
  "memoryView.tab.search": "Busca",
  "memoryView.tab.file": "MEMORY.md",
  "memoryView.stats.entities": "{count} entidades",
  "memoryView.stats.relations": "{count} relações",
  "memoryView.file.noProject": "Selecione um projeto para ver seu arquivo MEMORY.md.",
  "memoryView.file.loading": "Carregando MEMORY.md...",
  "memoryView.file.missingTitle": "Ainda não há MEMORY.md",
  "memoryView.file.missingDescription": "O Otto lê o MEMORY.md da raiz do projeto no início da sessão. O agente registra ali aprendizados, decisões e contexto que valem ser preservados entre sessões.",
  "memoryView.file.creating": "Criando...",
  "memoryView.file.createAction": "Criar MEMORY.md",
  "memoryView.file.unsaved": "Alterações não salvas",
  "memoryView.file.reloadAria": "Recarregar MEMORY.md",
  "memoryView.file.saving": "Salvando...",
  "memoryView.file.saveAction": "Salvar",
  "memoryView.file.saveFailed": "Não foi possível salvar o MEMORY.md",
  "memoryView.file.placeholder": "A memória do projeto está vazia.",
  "memoryView.file.editorAria": "Editor do MEMORY.md",
};
