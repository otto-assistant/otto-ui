...
export const dict: Record<I18nKey, string> = {
  ...
  "connectionStatus.reconnecting": "Повторне підключення",
  "connectionStatus.disconnected": "Відключено",
  "memoryView.heading": "Пам'ять",
  "memoryView.tab.graph": "Граф",
  "memoryView.tab.list": "Список",
  "memoryView.tab.diary": "Щоденник",
  "memoryView.tab.search": "Пошук",
  "memoryView.tab.file": "MEMORY.md",
  "memoryView.stats.entities": "{count} сутностей",
  "memoryView.stats.relations": "{count} зв'язків",
  "memoryView.file.noProject": "Виберіть проєкт, щоб переглянути його файл MEMORY.md.",
  "memoryView.file.loading": "Завантаження MEMORY.md...",
  "memoryView.file.missingTitle": "Файлу MEMORY.md ще немає",
  "memoryView.file.missingDescription": "Otto читає MEMORY.md з кореня проєкту на початку сесії. Агент зберігає тут знання, рішення та контекст, які варто зберегти між сесіями.",
  "memoryView.file.creating": "Створення...",
  "memoryView.file.createAction": "Створити MEMORY.md",
  "memoryView.file.unsaved": "Незбережені зміни",
  "memoryView.file.reloadAria": "Перезавантажити MEMORY.md",
  "memoryView.file.saving": "Збереження...",
  "memoryView.file.saveAction": "Зберегти",
  "memoryView.file.saveFailed": "Не вдалося зберегти MEMORY.md",
  "memoryView.file.placeholder": "Пам'ять проєкту порожня.",
  "memoryView.file.editorAria": "Редактор MEMORY.md",
};
