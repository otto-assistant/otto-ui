...
export const dict = {
  ...
  'memoryView.heading': 'Memory',
  'memoryView.tab.graph': 'Graph',
  'memoryView.tab.list': 'List',
  'memoryView.tab.diary': 'Diary',
  'memoryView.tab.search': 'Search',
  'memoryView.tab.file': 'MEMORY.md',
  'memoryView.stats.entities': '{count} entities',
  'memoryView.stats.relations': '{count} relations',
  'memoryView.file.noProject': 'Select a project to view its MEMORY.md file.',
  'memoryView.file.loading': 'Loading MEMORY.md...',
  'memoryView.file.missingTitle': 'No MEMORY.md yet',
  'memoryView.file.missingDescription': 'Otto reads MEMORY.md from the project root at session start. The agent uses it to store learnings, decisions, and context worth preserving across sessions.',
  'memoryView.file.creating': 'Creating...',
  'memoryView.file.createAction': 'Create MEMORY.md',
  'memoryView.file.unsaved': 'Unsaved changes',
  'memoryView.file.reloadAria': 'Reload MEMORY.md',
  'memoryView.file.saving': 'Saving...',
  'memoryView.file.saveAction': 'Save',
  'memoryView.file.saveFailed': 'Failed to save MEMORY.md',
  'memoryView.file.placeholder': 'Project memory is empty.',
  'memoryView.file.editorAria': 'MEMORY.md editor',
} as const;
