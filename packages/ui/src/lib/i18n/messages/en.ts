...
export const dict = {
  ...
  'chat.chatInput.permissionAutoAccept.disable': 'Disable yolo mode (permission auto-accept)',
  'chat.chatInput.permissionAutoAccept.enable': 'Enable yolo mode (permission auto-accept)',
  'chat.chatInput.permissionAutoAccept.on': 'Yolo mode: on',
  'chat.chatInput.permissionAutoAccept.off': 'Yolo mode: off',
