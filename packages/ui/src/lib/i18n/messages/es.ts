...
export const dict: Record<I18nKey, string> = {
  ...
  "memoryView.heading": "Memoria",
  "memoryView.tab.graph": "Grafo",
  "memoryView.tab.list": "Lista",
  "memoryView.tab.diary": "Diario",
  "memoryView.tab.search": "Búsqueda",
  "memoryView.tab.file": "MEMORY.md",
  "memoryView.stats.entities": "{count} entidades",
  "memoryView.stats.relations": "{count} relaciones",
  "memoryView.file.noProject": "Selecciona un proyecto para ver su archivo MEMORY.md.",
  "memoryView.file.loading": "Cargando MEMORY.md...",
  "memoryView.file.missingTitle": "Aún no hay MEMORY.md",
  "memoryView.file.missingDescription": "Otto lee MEMORY.md desde la raíz del proyecto al iniciar la sesión. El agente guarda allí aprendizajes, decisiones y contexto que vale la pena conservar entre sesiones.",
  "memoryView.file.creating": "Creando...",
  "memoryView.file.createAction": "Crear MEMORY.md",
  "memoryView.file.unsaved": "Cambios sin guardar",
  "memoryView.file.reloadAria": "Recargar MEMORY.md",
  "memoryView.file.saving": "Guardando...",
  "memoryView.file.saveAction": "Guardar",
  "memoryView.file.saveFailed": "No se pudo guardar MEMORY.md",
  "memoryView.file.placeholder": "La memoria del proyecto está vacía.",
  "memoryView.file.editorAria": "Editor de MEMORY.md",
};
