...
import lemonwater_dark_Raw from './lemonwater-dark.json';
import lemonwater_light_Raw from './lemonwater-light.json';
...
export const presetThemes: Theme[] = [
  ...
  lemonwater_dark_Raw as Theme,
  lemonwater_light_Raw as Theme,
